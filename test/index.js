...
test('Android phones keep mobile form factor', t => {
  const userAgent =
...
test('Android tablets are not mobile and use Tablet form factor', t => {
  // Chrome on Android tablets: Sec-CH-UA-Mobile=?0 and form-factor Tablet.
  // Phone vs tablet is distinguished by the Mobile token in the UA string.
  const userAgent =
